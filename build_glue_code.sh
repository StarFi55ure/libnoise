...
em++ -s EXPORT_NAME="'LibNoise'" -s MODULARIZE=1 -s ASSERTIONS=1 -O2 --memory-init-file 0 libnoise_glue.cpp -Lbuild/src -lnoise --post-js postfix.js -s DEMANGLE_SUPPORT=1 -o build/libnoise.js
